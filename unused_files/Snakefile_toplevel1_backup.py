...
if bulk_flag =='Yes' or bulk_flag == 'yes' or bulk_flag == 'Y'or bulk_flag =='y':
  rule all_withbulk:
    input:
      ...
      # Bulk outputs 
      expand("{bulksample}/metaquast_report_metaSPAdesBulk.{bulksample}.txt", bulksample=bulksampleIDs),
      expand("{bulksample}/metaquast_report_megahitBulk.{bulksample}.txt", bulksample=bulksampleIDs),
